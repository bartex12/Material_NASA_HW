...
class EarthViewModel: ViewModel() {
    ...
    private val pictureRepo: IPictureEarthRepo = PictureEarthRepo(ApiFactoryPictureOfEarth.API)
    ...
    private fun loadPictures() {
        ...
        pictureEarthSealed.value = PictureEarthSealed.Loading(null)
        pictureRepo.getPictureOfEarth()
            .observeOn(AndroidSchedulers.mainThread())
            .subscribe({
                pictureEarthSealed.value = PictureEarthSealed.Success(listPicturesOfEarth = it)
            },{
                pictureEarthSealed.value = PictureEarthSealed.Error(error = it)
            })
    }
